...
int test_producer_to_consumer() {
    // Create an AsyncBuffer and link ProducerBuffer and ConsumerBuffer
    auto async_buffer = std::make_shared<AsyncBuffer>();
...
int test_producer_reserve() {
    // Create an AsyncBuffer and link ProducerBuffer
    auto async_buffer = std::make_shared<AsyncBuffer>();
    auto producer = async_buffer->Producer();
...
int test_producer_consumer_concurrent() {
    ...
    auto producer_thread = [producer]() {
        ...
        *producer << AsyncBuffer::Status::EoF; // Signal EOF
    };
...
int test_producer_to_consumer_eof() {
    ...
    *async_buffer << AsyncBuffer::Status::EoF; // Use operator<< for smart pointer
    ...
    ASSERT_TRUE("test_producer_to_consumer_eof", (AsyncBuffer::Status::EoF == async_buffer->Status()));
